...
<body>
	...
	<%
	Cookie cookie2 = new Cookie("addCookie1", "쿠키추가합니다1"); // 쿠키 생성
	cookie2.setPath(request.getContextPath()); // 경로를 컨텍스트 루트로 설정
	cookie2.setMaxAge(3600); // 유지 기간을 1시간으로 설정
	response.addCookie(cookie2); // 응답 헤더에 쿠키 추가
	%>
